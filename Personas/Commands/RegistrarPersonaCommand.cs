...
{
    public class RegistrarPersonaCommand: MediatR.IRequest<Resultado>
    {
        ...
        public RegistrarPersonaCommand(Guid personaId, DatosGeneralesPersona generalidadesPersona, DatosFamiliaresPersona familiaresPersona, List<DatosDomiciliosPersona> domicilioPersona, List<TelefonoPersona> telefonosPersona, List<CorreoPersona> correosPersona)
        {
            PersonaId = personaId;
